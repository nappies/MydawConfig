...
reaper.SetExtState('MyDaw', 'IsReverseSel', 'IsReverseSel', false)


local raz_start_pos = SnapPrevGridLine(reaper.GetCursorPosition())
local raz_end_pos = reaper.GetCursorPosition()
