...
-- Deselect MIDI events outside time selection (optimized version)
...
local function SelAllInTsDuplicate()
  ...
  jsUnselectNotInTime()
  reaper.MIDIEditor_OnCommand(midieditor, 40733) -- Smart copy
  reaper.PreventUIRefresh(-1)
...
local function DuplicateEventsOnly()
  ...
  reaper.Undo_BeginBlock()
  reaper.PreventUIRefresh(1)
  reaper.MIDIEditor_OnCommand(midieditor, 40440) -- Move cursor to end of selected events
