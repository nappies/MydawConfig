...
function Component() {
	...
	if (systemInfo.kernelType === "darwin")
		{
		 installer.componentByName("com.cockos").setValue("Virtual", "true");
		 installer.componentByName("com.fonts").setValue("Virtual", "true");
		 installer.componentByName("com.fonts").setValue("Default", "true");
		
		 installer.componentByName("com.cockos.reaper_arm64").setValue("Virtual", "true");
		 installer.componentByName("com.cockos.reaper_x86_64").setValue("Virtual", "true");


		if ( systemInfo.currentCpuArchitecture === "x86_64") {
			installer.componentByName("com.cockos.reaper_x86_64").setValue("Virtual", "false");
			installer.componentByName("com.cockos.reaper_x86_64").setValue("Default", "true");
		}
		else 
		{
			installer.componentByName("com.cockos.reaper_arm64").setValue("Virtual", "false");
			installer.componentByName("com.cockos.reaper_arm64").setValue("Default", "true");
		}
